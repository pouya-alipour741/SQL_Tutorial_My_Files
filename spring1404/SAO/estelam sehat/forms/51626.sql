 ...
 INSERT INTO Form.TblForm(FormId,Name,IsActive,Description,Resource,IsSearchForm,LastModifiedDate,GUID,ISPersistable,HelpLink,HTMLResource,DefaultCulture ) VALUES (51626, N'استعلام کد صحت',1, N'', N'<cm:TZBaseControl xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:sk="http://schemas.microsoft.com/winfx/2006/xaml/presentation/sdk" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" xmlns:cm="clr-namespace:ITS.FormGenerator.Component.SL;assembly=ITS.FormGenerator.Component.WPF" xmlns:my="clr-namespace:Liquid;assembly=Liquid" xmlns:my1="clr-namespace:Liquid;assembly=RichTextEditor" Height="730.03333333" Background="White">
  <Canvas Width="950" Height="632">
    ...
    <Validations xmlns="">
      <Validation>
        ...
        <ExpressionConditions>
          <ExpressionCondition>
            ...
            <ExpressionConditionID>5596453525501463402</ExpressionConditionID>
            <Operator>==</Operator>
            <Value>True</Value>
          </ExpressionCondition>
          <ExpressionCondition>
            ...
            <ComponentProperty>Value</ComponentProperty>
            <ExpressionConditionID>4811026581456067231</ExpressionConditionID>
            <Operator>==</Operator>
            <Value>''''</Value>
          </ExpressionCondition>
        </ExpressionConditions>
      ...
      <Validation>
        <ID>4961053176096504866</ID>
        <Name>اجباری بودن فیلدهای نوع سازمان و نام سازمان</Name>
        ...
        <ExpressionConditions>
          <ExpressionCondition>
            ...
            <ComponentDataType>bit</ComponentDataType>
            <ComponentProperty>Value</ComponentProperty>
            <ExpressionConditionID>5674611056881010305</ExpressionConditionID>
            <Operator>==</Operator>
            <Value>True</Value>
          </ExpressionCondition>
        </ExpressionConditions>
    ...
    <cm:TzGroupBox Name="GroupBox2" Width="934" Height="616" ControlID="5761654803702935413" FontFamily="Tahoma" Canvas.Left="8" Canvas.Top="8" cm:Header="استعلام کد صحت">
      <Canvas>
        <cm:Grid Width="906" Height="578.51666666666665" ControlID="4828199045162456394" Canvas.Left="8" Canvas.Top="8">
          ...
          <cm:TZButton Name="btnInq" Content="استعلام" Width="167" Height="23" Margin="0,0,0,11.9107009640153" HorizontalAlignment="Center" VerticalAlignment="Bottom" ControlID="5667435355702452203" Grid.Column="4" Grid.ColumnSpan="2" Grid.Row="7" cm:Event="dsbtnInquiry" cm:Validations="5066180879002247310,4961053176096504866" />
...
</cm:TZBaseControl>',IsSearchForm = 0,LastModifiedDate = '2025/06/09 16:27:46', GUID = 'f5482385-ca86-48be-8e94-4fbcdfebd3e2', ISPersistable = 0,HelpLink = N'',HTMLResource = N'{"formID": "51626" ,"components": [{"value": "","key": "4650000845302587224","label": "chkDescriptionState","controlType": "checkbox","caption": "TZCheckBox" ,"DataBindingField" : "Res"},{"value": "","key": "4632371938225071137","label": "chkInquiryValidity","controlType": "checkbox","caption": "InquiryValidity" ,"DataBindingField" : "codeIsValid"},{"value": "","key": "4728487324510420247","label": "chkMandatory_OrgsComboboxes","controlType": "checkbox","caption": "TZCheckBox" ,"DataBindingField" : "res"},{"value": "","key": "5605355018541395794","label": "chkRadioButtonsState","controlType": "checkbox","caption": "TZCheckBox" ,"DataBindingField" : "InquiryButtonState"},{"key": "5045268888212402062","label": "cmbOrgName","value": "", "controlType": "dropdown","options":""},{"key": "5181846831418919335","label": "cmbOrgType","value": "", "controlType": "dropdown","options":""},{"key":"5483642522873530736" , "dataSourceName":"dsbtnInquiry" , "controlType": "datasource",  "selectQuery" :"SP_CU_Insert_TBL_CU_InquiryCertificateCode" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"key":"5224761172985296360" , "dataSourceName":"dschkDescriptionState" , "controlType": "datasource",  "selectQuery" :"SP_CU_EnabletxtOtherUnit_StudentCertification" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"key":"5006111681685664293" , "dataSourceName":"dschkMandatory_OrgsComboboxes" , "controlType": "datasource",  "selectQuery" :"SP_CU_Mandatory_OrgsComboboxes_frm51624" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"key":"5440281383001370476" , "dataSourceName":"dschkRadioButtonsState" , "controlType": "datasource",  "selectQuery" :"SP_CU_RadioButtonsState_Controller_frm51624" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"key":"5569867153699646889" , "dataSourceName":"dsOrgName" , "controlType": "datasource",  "selectQuery" :"Sp_Cu_Read_Tbl_Cu_Base_RequestedOrganizations" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"key":"5490128771523394600" , "dataSourceName":"dsOrgType" , "controlType": "datasource",  "selectQuery" :"Sp_Cu_Read_Tbl_Cu_Base_RequestedOrganizationsType" , "connectionName" :"SAODB" , "runQueryMode":"Text" , "relatedComponent" :[] } ,{"value": "","key": "5383101998144965866","label": "txtDescription","controlType": "textbox", "type": "" , "DataBindingField" : ""},{"value": "","key": "5716382208503520831","label": "txtValidityCode","controlType": "textbox", "type": "" , "DataBindingField" : ""}],"layouts":[]}',DefaultCulture = NULL  WHERE FormId = 51626
GO
----------
 SET IDENTITY_INSERT Form.TblForm OFF 
GO
----------
 IF NOT EXISTS ( SELECT name FROM sysobjects WHERE xtype='U' AND  NAME = 'Tbl_frm51626') BEGIN SET ANSI_NULLS ON  SET QUOTED_IDENTIFIER ON  
 CREATE TABLE [dbo].[Tbl_frm51626] ( [frm51626Id]  [bigint] IDENTITY(1,1) NOT NULL , [Col_5716382208503520831]  [nvarchar] ( 50) NULL , [Col_5383101998144965866]  [nvarchar] ( 50) NULL , [Col_5181846831418919335]  [nvarchar] ( 50) NULL , [Col_5045268888212402062]  [nvarchar] ( 50) NULL , [Col_5682925167809697056]  [bit] NULL , [Col_5536751798350188447]  [bit] NULL , [Col_4906205338905471772]  [bit] NULL , [Col_5297751233599887583]  [bit] NULL , [Col_5605355018541395794]  [bit] NULL , [Col_4650000845302587224]  [bit] NULL , [Col_4632371938225071137]  [bit] NULL , [Col_4728487324510420247]  [bit] NULL ,  PRIMARY KEY CLUSTERED ( [frm51626Id] ASC ) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY] ) ON [PRIMARY]  END 
 ELSE 
 BEGIN 
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'frm51626Id' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD frm51626Id bigint NOT NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'Col_5716382208503520831' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD Col_5716382208503520831 nvarchar (50) NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'Col_5383101998144965866' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD Col_5383101998144965866 nvarchar (50) NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'Col_5181846831418919335' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD Col_5181846831418919335 nvarchar (50) NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'Col_5045268888212402062' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD Col_5045268888212402062 nvarchar (50) NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'Col_5682925167809697056' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD Col_5682925167809697056 bit NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'Col_5536751798350188447' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD Col_5536751798350188447 bit NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'Col_4906205338905471772' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD Col_4906205338905471772 bit NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'Col_5297751233599887583' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD Col_5297751233599887583 bit NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'Col_5605355018541395794' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD Col_5605355018541395794 bit NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'Col_4650000845302587224' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD Col_4650000845302587224 bit NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'Col_4632371938225071137' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD Col_4632371938225071137 bit NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm51626' AND COLUMN_NAME = 'Col_4728487324510420247' )  BEGIN ALTER TABLE [dbo].[Tbl_frm51626] ADD Col_4728487324510420247 bit NULL END  
 END 
----------
 IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_Insert_frm51626]') AND type in (N'P', N'PC')) DROP PROCEDURE SP_Insert_frm51626
GO----------
 CREATE PROCEDURE [dbo].[SP_Insert_frm51626] ( @PKFormId as bigint OUTPUT ,  @Col_5716382208503520831 AS nvarchar(50),  @Col_5383101998144965866 AS nvarchar(50),  @Col_5181846831418919335 AS nvarchar(50),  @Col_5045268888212402062 AS nvarchar(50),  @Col_5682925167809697056 AS bit,  @Col_5536751798350188447 AS bit,  @Col_4906205338905471772 AS bit,  @Col_5297751233599887583 AS bit,  @Col_5605355018541395794 AS bit,  @Col_4650000845302587224 AS bit,  @Col_4632371938225071137 AS bit,  @Col_4728487324510420247 AS bit ) AS BEGIN 
 INSERT INTO [dbo].[Tbl_frm51626](Col_5716382208503520831,Col_5383101998144965866,Col_5181846831418919335,Col_5045268888212402062,Col_5682925167809697056,Col_5536751798350188447,Col_4906205338905471772,Col_5297751233599887583,Col_5605355018541395794,Col_4650000845302587224,Col_4632371938225071137,Col_4728487324510420247) VALUES ( @Col_5716382208503520831,@Col_5383101998144965866,@Col_5181846831418919335,@Col_5045268888212402062,@Col_5682925167809697056,@Col_5536751798350188447,@Col_4906205338905471772,@Col_5297751233599887583,@Col_5605355018541395794,@Col_4650000845302587224,@Col_4632371938225071137,@Col_4728487324510420247 )  SELECT @PKFormId = Convert(bigint, @@IDENTITY) 
 END 
GO----------
 IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_Update_frm51626]') AND type in (N'P', N'PC')) DROP PROCEDURE SP_Update_frm51626
GO----------
 CREATE PROCEDURE [dbo].[SP_Update_frm51626] ( @PKFormId as bigint OUTPUT ,  @Col_5716382208503520831 AS nvarchar(50),  @Col_5383101998144965866 AS nvarchar(50),  @Col_5181846831418919335 AS nvarchar(50),  @Col_5045268888212402062 AS nvarchar(50),  @Col_5682925167809697056 AS bit,  @Col_5536751798350188447 AS bit,  @Col_4906205338905471772 AS bit,  @Col_5297751233599887583 AS bit,  @Col_5605355018541395794 AS bit,  @Col_4650000845302587224 AS bit,  @Col_4632371938225071137 AS bit,  @Col_4728487324510420247 AS bit ) AS BEGIN 
 UPDATE [dbo].[Tbl_frm51626] SET Col_5716382208503520831 =  @Col_5716382208503520831, Col_5383101998144965866 =  @Col_5383101998144965866, Col_5181846831418919335 =  @Col_5181846831418919335, Col_5045268888212402062 =  @Col_5045268888212402062, Col_5682925167809697056 =  @Col_5682925167809697056, Col_5536751798350188447 =  @Col_5536751798350188447, Col_4906205338905471772 =  @Col_4906205338905471772, Col_5297751233599887583 =  @Col_5297751233599887583, Col_5605355018541395794 =  @Col_5605355018541395794, Col_4650000845302587224 =  @Col_4650000845302587224, Col_4632371938225071137 =  @Col_4632371938225071137, Col_4728487324510420247 =  @Col_4728487324510420247 WHERE [frm51626Id] = @PKFormId 
 END 
GO
