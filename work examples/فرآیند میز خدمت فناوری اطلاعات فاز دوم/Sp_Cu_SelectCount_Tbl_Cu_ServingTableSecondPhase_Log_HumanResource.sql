--exec Sp_Cu_SelectCount_Tbl_Cu_ServingTableSecondPhase_Log_HumanResource_test @FromDate=N'1403/12/05',@ToDate=N'1403/12/11'
					   ...
					   (select
						...
						where
							 ...
							 and t.UserID in
										...
										where
											RoleID in(4,6)  --ÔÑØ åÇ? ˜ÇÑÈÑ ÇÞÏÇã ˜ääÏå ÈæÏä
											and StatusActing != 2)
							) Actor_hours
