          ...
          <Canvas>
            ...
            <cm:tzDataGrid Name="gvQuestionAnswer" Width="1127.4300000000003" Height="403" HorizontalAlignment="Right" VerticalAlignment="Top" ControlID="5520743959566919198" ItemsSource="{Binding ElementName=dsSearchQuestionAnswer, Path=DataItems}" Canvas.Left="10.57" Canvas.Top="221.03333334" cm:BindingForm="dsSearchQuestionAnswer" cm:Event="dsSelectKey,dsSelectwfid" cm:IsSearchable="True" cm:KeyField="Id" cm:MultiSelect="True" cm:UserCanExport="True">
              ...
              <cm:tzDataGrid.Columns>
                ...
                <cm:tzDataGridTemplateColumn Width="55" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="RegisteredTime" DecimalMark="False" HeaderText="زمان ثبت" IsRowColorField="False" KeyField="False" SortMemberPath="RegisteredTime">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
