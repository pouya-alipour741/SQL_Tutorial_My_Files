 ...
 INSERT INTO Form.TblForm(FormId,Name,IsActive,Description,Resource,IsSearchForm,LastModifiedDate,GUID,ISPersistable,HelpLink,HTMLResource,DefaultCulture ) VALUES (41606, N'پاسخ های آماده درخواست پشتیبانی',1, N'', N'<cm:TZBaseControl xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:sk="http://schemas.microsoft.com/winfx/2006/xaml/presentation/sdk" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" xmlns:cm="clr-namespace:ITS.FormGenerator.Component.SL;assembly=ITS.FormGenerator.Component.WPF" xmlns:my="clr-namespace:Liquid;assembly=Liquid" xmlns:my1="clr-namespace:Liquid;assembly=RichTextEditor" Background="White">
  <Canvas Width="950" Height="570">
    ...
    <cm:Grid Width="924" Height="554" ControlID="5318419757201397511" Canvas.Left="18" Canvas.Top="8">
      ...
      <cm:tzDataSource Name="dsMainSubject" Content="dsMainSubject" Width="110" Height="25.000000000000014" Margin="661.020570186652,92.3422812700001,0,0" HorizontalAlignment="Left" VerticalAlignment="Top" ControlID="5207340050635669024" Grid.Column="0" Grid.ColumnSpan="2" Grid.Row="0" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:RunQueryMode="StoredProcedure" cm:tzSelectQuery="Sp_Cu_GetMainSubject_frm41606">
      ...
      <cm:tzDataGrid Name="gvPremadeResponses" Width="549" Height="187" Margin="0,101.683477309335,35,0" HorizontalAlignment="Right" VerticalAlignment="Top" ControlID="5748817850940583254" ItemsSource="{Binding ElementName=dsgvPremadeResponses, Path=DataItems}" Grid.Column="0" Grid.ColumnSpan="2" Grid.Row="1" cm:BindingForm="dsgvPremadeResponses" cm:EventForAdd="dsgvPremadeResponses" cm:EventForEdit="dsgvPremadeResponses" cm:Form="41607" cm:FormName="فرم پایه تعریف پاسخ های آماده درخواست پشتیبانی" cm:KeyField="PremadeResponses_ID" cm:ParamValues="4936476346195877437¢MainSubject" cm:UserCanEdit="True" cm:UserCanInsert="True" cm:ViewLayoutId="-1">
        ...
        <cm:tzDataGrid.Columns>
          <cm:tzDataGridTemplateColumn Width="20" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="rn" DecimalMark="False" HeaderText="ردیف" IsRowColorField="False" KeyField="False" SortMemberPath="rn">
            <cm:tzDataGridTemplateColumn.CellTemplate>
              <cm:TzDataTemplate>
                <TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" Text="{Binding rn}" TextWrapping="Wrap" />
              </cm:TzDataTemplate>
            </cm:tzDataGridTemplateColumn.CellTemplate>
          ...
          <cm:tzDataGridTemplateColumn Width="50" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="MainSubject" DecimalMark="False" HeaderText="موضوع اصلی" IsRowColorField="False" KeyField="False" SortMemberPath="MainSubject">
            <cm:tzDataGridTemplateColumn.CellTemplate>
              <cm:TzDataTemplate>
          ...
          <cm:tzDataGridTemplateColumn Width="40" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="RequestType" DecimalMark="False" HeaderText="عنوان درخواست " IsRowColorField="False" KeyField="False" SortMemberPath="RequestType">
            <cm:tzDataGridTemplateColumn.CellTemplate>
              <cm:TzDataTemplate>
          ...
          <cm:tzDataGridTemplateColumn Width="90" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="Response" DecimalMark="False" HeaderText="پاسخ" IsRowColorField="False" KeyField="False" SortMemberPath="Response">
            <cm:tzDataGridTemplateColumn.CellTemplate>
              <cm:TzDataTemplate>
          ...
          <cm:tzDataGridTemplateColumn Width="20" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="status" DecimalMark="False" HeaderText="وضعیت" IsRowColorField="False" KeyField="False" SortMemberPath="status">
            <cm:tzDataGridTemplateColumn.CellTemplate>
              <cm:TzDataTemplate>
...
</cm:TZBaseControl>',1,'1403/11/20 13:04:46', 'c5ec7a30-126c-4e69-8819-8053032a018c', 0, N'', N'{"formID": "41606" ,"components": [{"value": "","key": "4756151329983957276","label": "chkFilledMainSubject","controlType": "checkbox","caption": "TZCheckBox" ,"DataBindingField" : "res"},{"key": "4936476346195877437","label": "cmbMainSubject","value": "", "controlType": "dropdown","options":""},{"key":"4733857338082025567" , "dataSourceName":"dschkFilledMainSubject" , "controlType": "datasource",  "selectQuery" :"sp_cu_chk_IsMainSubjectEmpty" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"key":"5325081676817357846" , "dataSourceName":"dsgvPremadeResponses" , "controlType": "datasource",  "selectQuery" :"sp_cu_gvPremadeResponses_frm41606" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"key":"5207340050635669024" , "dataSourceName":"dsMainSubject" , "controlType": "datasource",  "selectQuery" :"Sp_Cu_GetMainSubject_frm41606" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"value": "$CurrentUserId","key": "4933789186363820479","label": "txtUserID","controlType": "textbox", "type": "" , "DataBindingField" : ""}],"layouts":[]}',NULL) 
...
</cm:TZBaseControl>',IsSearchForm = 1,LastModifiedDate = '1403/11/20 13:04:46', GUID = 'c5ec7a30-126c-4e69-8819-8053032a018c', ISPersistable = 0,HelpLink = N'',HTMLResource = N'{"formID": "41606" ,"components": [{"value": "","key": "4756151329983957276","label": "chkFilledMainSubject","controlType": "checkbox","caption": "TZCheckBox" ,"DataBindingField" : "res"},{"key": "4936476346195877437","label": "cmbMainSubject","value": "", "controlType": "dropdown","options":""},{"key":"4733857338082025567" , "dataSourceName":"dschkFilledMainSubject" , "controlType": "datasource",  "selectQuery" :"sp_cu_chk_IsMainSubjectEmpty" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"key":"5325081676817357846" , "dataSourceName":"dsgvPremadeResponses" , "controlType": "datasource",  "selectQuery" :"sp_cu_gvPremadeResponses_frm41606" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"key":"5207340050635669024" , "dataSourceName":"dsMainSubject" , "controlType": "datasource",  "selectQuery" :"Sp_Cu_GetMainSubject_frm41606" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"value": "$CurrentUserId","key": "4933789186363820479","label": "txtUserID","controlType": "textbox", "type": "" , "DataBindingField" : ""}],"layouts":[]}',DefaultCulture = NULL  WHERE FormId = 41606
GO
----------
    ...
    <cm:TzGroupBox Name="GroupBox2" Width="719" Height="336" Background="#FF12ABD1" BorderBrush="#FF070707" ControlID="4728099207496675246" Canvas.Left="115.2835443" Canvas.Top="122.75833333" cm:Header="">
      <Canvas>
        <cm:Grid Width="691" Height="308" ControlID="5260485815322963706" Canvas.Left="8" Canvas.Top="8">
          ...
          <cm:tzLabel Name="Lable5" Content="عنوان درخواست" Width="405" Height="24.48333333" Margin="0,14,37.2835443,0" HorizontalAlignment="Right" VerticalAlignment="Top" ControlID="5495263361587021193" FontFamily="Tahoma" Grid.Column="0" Grid.ColumnSpan="3" Grid.Row="1" />
          <cm:tzLabel Name="Lable7" Content="پاسخ" Width="412.2835443" Height="24.48333333" Margin="248.7164557,8.48333333000005,30,0" HorizontalAlignment="Stretch" VerticalAlignment="Top" ControlID="5031072397526824377" FontFamily="Tahoma" Grid.Column="0" Grid.ColumnSpan="3" Grid.Row="2" />
          <cm:tzTextBox Name="txtMainSubject" Width="120" Height="21" Margin="24.8707002633031,0,21.9999999999995,15.03333334" HorizontalAlignment="Stretch" VerticalAlignment="Bottom" ControlID="4781473934816942684" Grid.Column="2" Grid.Row="0" cm:DataBinding="dsRecoveredMainSubject" cm:DataBindingField="Name" cm:DefaultValue="@@MainSubject" cm:IsEnableItem="False" cm:Persistable="True" cm:PersistFieldName="MainSubject" />
          ...
          <cm:tzDataSource Name="dsRecoveredMainSubject" Content="dsRecoveredMainSubject" Width="58.000000000000007" Height="25" Margin="0,0,104.74177215,37.03333334" HorizontalAlignment="Right" VerticalAlignment="Bottom" ControlID="5433583936544774254" Grid.Column="2" Grid.Row="0" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:RunQueryMode="StoredProcedure" cm:tzSelectQuery="sp_cu_RecoveredMainSubject">
            <cm:tzDataSource.StoredProcedureParameterValue>
              <TZStoredProcedure xmlns="clr-namespace:ITS.FormGenerator.Component.SL.Controls;assembly=ITS.FormGenerator.Component.WPF" ComponentName=" {@txtMainSubjectID}" IsOutputParameter="False" ParameterType="int" SpParamName=" @MainSubject" />
            </cm:tzDataSource.StoredProcedureParameterValue>
          </cm:tzDataSource>
          ...
          <cm:tzTextBox Name="txtMainSubjectID" Width="120" Height="21" Margin="0,24.48333333,29.4128440366973,0" HorizontalAlignment="Right" VerticalAlignment="Top" ControlID="5077630523876558823" Grid.Column="1" Grid.Row="0" cm:DataType="Int" cm:DefaultValue="@@MainSubject" cm:Event="dsRecoveredMainSubject" cm:IsVisibleItem="False" cm:Persistable="True" cm:PersistFieldName="MainSubjectID" />
          <cm:tzTextBox Name="txtRequestType" Width="481" Height="21" Margin="0,0,30,26.9999999999997" HorizontalAlignment="Right" VerticalAlignment="Bottom" ControlID="5377042739550064811" Grid.Column="0" Grid.ColumnSpan="3" Grid.Row="1" cm:Len="100" cm:Persistable="True" cm:PersistFieldName="RequestType" />
          <cm:tzTextBox Name="txtResponse" Width="481" Height="42" Margin="0,0,30,11.9999999999997" HorizontalAlignment="Right" VerticalAlignment="Bottom" ControlID="4931345524520181736" Grid.Column="0" Grid.ColumnSpan="3" Grid.Row="2" cm:IsMulitiLine="True" cm:Len="1000" cm:Persistable="True" cm:PersistFieldName="Response" />
        </cm:Grid>
      </Canvas>
    </cm:TzGroupBox>
  </Canvas>
</cm:TZBaseControl>',0,'1403/11/14 12:11:16', '6c877d96-c38c-4739-9c2a-0d502fc2ed2b', 1, N'', N'{"formID": "41607" ,"components": [{"value": "True","key": "4796154223235079582","label": "chkStatus","controlType": "checkbox","caption": "فعال" ,"DataBindingField" : ""},{"key":"5433583936544774254" , "dataSourceName":"dsRecoveredMainSubject" , "controlType": "datasource",  "selectQuery" :"sp_cu_RecoveredMainSubject" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"value": "@@MainSubject","key": "4781473934816942684","label": "txtMainSubject","controlType": "textbox", "type": "" , "DataBindingField" : "Name"},{"value": "@@MainSubject","key": "5077630523876558823","label": "txtMainSubjectID","controlType": "textbox", "type": "" , "DataBindingField" : ""},{"value": "","key": "5377042739550064811","label": "txtRequestType","controlType": "textbox", "type": "" , "DataBindingField" : ""},{"value": "","key": "4931345524520181736","label": "txtResponse","controlType": "textbox", "type": "" , "DataBindingField" : ""},{"value": "$CurrentUserId","key": "4820877390337943060","label": "txtUserID","controlType": "textbox", "type": "" , "DataBindingField" : ""}],"layouts":[]}',NULL) 
...
</cm:TZBaseControl>',IsSearchForm = 0,LastModifiedDate = '1403/11/14 12:11:16', GUID = '6c877d96-c38c-4739-9c2a-0d502fc2ed2b', ISPersistable = 1,HelpLink = N'',HTMLResource = N'{"formID": "41607" ,"components": [{"value": "True","key": "4796154223235079582","label": "chkStatus","controlType": "checkbox","caption": "فعال" ,"DataBindingField" : ""},{"key":"5433583936544774254" , "dataSourceName":"dsRecoveredMainSubject" , "controlType": "datasource",  "selectQuery" :"sp_cu_RecoveredMainSubject" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"value": "@@MainSubject","key": "4781473934816942684","label": "txtMainSubject","controlType": "textbox", "type": "" , "DataBindingField" : "Name"},{"value": "@@MainSubject","key": "5077630523876558823","label": "txtMainSubjectID","controlType": "textbox", "type": "" , "DataBindingField" : ""},{"value": "","key": "5377042739550064811","label": "txtRequestType","controlType": "textbox", "type": "" , "DataBindingField" : ""},{"value": "","key": "4931345524520181736","label": "txtResponse","controlType": "textbox", "type": "" , "DataBindingField" : ""},{"value": "$CurrentUserId","key": "4820877390337943060","label": "txtUserID","controlType": "textbox", "type": "" , "DataBindingField" : ""}],"layouts":[]}',DefaultCulture = NULL  WHERE FormId = 41607
GO
----------
 SET IDENTITY_INSERT Form.TblForm OFF 
GO
...
GO
 ...
 INSERT INTO Form.TblForm(FormId,Name,IsActive,Description,Resource,IsSearchForm,LastModifiedDate,GUID,ISPersistable,HelpLink,HTMLResource,DefaultCulture ) VALUES (41608, N'فرم جستجو پیشرفته فرایند درخواست پشتیبانی کاربران دانشگاهی',1, N'', N'<cm:TZBaseControl xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:sk="http://schemas.microsoft.com/winfx/2006/xaml/presentation/sdk" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" xmlns:cm="clr-namespace:ITS.FormGenerator.Component.SL;assembly=ITS.FormGenerator.Component.WPF" xmlns:my="clr-namespace:Liquid;assembly=Liquid" xmlns:my1="clr-namespace:Liquid;assembly=RichTextEditor" Width="1237" Height="982" Background="White">
  <Canvas Width="1202" Height="941">
    ...
    <cm:TzGroupBox Name="GroupBox2" Width="1186" Height="925" Background="#FF06427F" ControlID="4763975330562137876" Canvas.Left="8" Canvas.Top="8" cm:Header="">
      <Canvas>
        <cm:TzGroupBox Name="GroupBox4" Width="1158" Height="888.51666666666665" Background="#FFC5DEF7" BorderBrush="#FF0BCDEF" BorderThickness="2,2,2,2" ControlID="4892098589973136482" Canvas.Left="8" Canvas.Top="8" cm:Header="">
          <Canvas>
            <cm:tzLookUpComboBox Name="cmbMainSubject" Width="296.95333333000013" Height="21" ControlID="5530768454771502173" Canvas.Left="732" Canvas.Top="7.7665032033334569" cm:ComboBoxDataSourceType="DataSystem" cm:DataBinding="dsMainSubject" cm:DataType="Int" cm:DefaultValue="$سومی" cm:Event="dsMandatory,dsSelectReadyAnswer" cm:tzDisplayItem="Name" cm:tzValueItem="WorkflowId" />
            <cm:tzTextBox Name="txtFollowUpCode" Width="140.34333334000007" Height="21" HorizontalAlignment="Right" ControlID="5093936520403204420" Canvas.Left="467.87999999999988" Canvas.Top="76.766503203333457" cm:DataType="BigInt" />
            <cm:tzTextBox Name="txtWFID" Width="140.93360995999998" Height="21" HorizontalAlignment="Right" ControlID="4870872938434230307" Canvas.Left="207" Canvas.Top="9.0000000000000568" cm:DataType="BigInt" />
            ...
            <cm:tzLookUpComboBox Name="cmbUsers" Width="140.34333334" Height="21" Canvas.Left="467.88" Canvas.Top="7" cm:ComboBoxDataSourceType="DataSystem" cm:ControlID="5461781533024897420" cm:DataBinding="dsUsers" cm:DataType="BigInt" cm:Event="dstest" cm:tzDisplayItem="Name" cm:tzValueItem="ID" />
            ...
            <cm:tzLabel Name="Lable29" Content=":کد پیگیری" Width="63" Height="23" ControlID="4901662744236561897" FontFamily="Tahoma" Canvas.Left="617.22333334" Canvas.Top="74.999999999999943" />
            ...
            <cm:TzGroupBox Name="GroupBox59" Width="1127.43" Height="107.40570539" ControlID="5759606125225975486" Canvas.Left="10.57" Canvas.Top="107" cm:Header="پاسخ گروهی">
              <Canvas>
                ...
                <cm:tzDataSource Name="dsSelectReadyAnswer" Content="dsSelectReadyAnswer" Width="136.83048543999982" Height="25" ControlID="4939650566442929498" Canvas.Left="681.76311611999972" Canvas.Top="-1.7106060600000319" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:RunQueryMode="StoredProcedure" cm:tzSelectQuery="Sp_Cu_Select_Tbl_Cu_Base_SaoReadyAnswer_Frm31108">
                  <cm:tzDataSource.StoredProcedureParameterValue>
            ...
            <cm:tzLookUpComboBox Name="cmbExpert" Width="140" Height="21" Canvas.Left="207" Canvas.Top="43" cm:ComboBoxDataSourceType="DataSystem" cm:ControlID="4861667107116646382" cm:DataBinding="dsExpert" cm:DataType="BigInt" cm:Event="dstest" cm:tzDisplayItem="FullName" cm:tzValueItem="UserId" />
            ...
            <cm:tzDataSource Name="dsSelectAnswer" Content="dsSelectAnswer" Width="137.93000000000046" Height="25" ControlID="4915910715601269065" Canvas.Left="858.19562813999983" Canvas.Top="165.31536766000008" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:RunQueryMode="Text" cm:tzSelectQuery="SELECT TOP 1 Answer FROM Tbl_Cu_Base_SaoReadyAnswer WHERE ReadSaoAnswerID ={@cmbReadyAnswer} " />
            ...
            <cm:tzDataSource Name="dsStatus" Content="dsStatus" Width="137.93000000000046" Height="25" ControlID="5555178140555476126" Canvas.Left="737.79509391999909" Canvas.Top="40.000000000000057" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:ForceReload="True" cm:RunQueryMode="StoredProcedure" cm:tzSelectQuery="Sp_Cu_GetWFStatus_SearchQuestionAnswer_frm41608" />
            <cm:tzDataSource Name="dsMainSubject" Content="dsMainSubject" Width="136.83048543999982" Height="25" ControlID="4791881557067791466" Canvas.Left="738.89460848" Canvas.Top="6.0000000000001705" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:ForceReload="True" cm:RunQueryMode="StoredProcedure" cm:tzSelectQuery="Sp_Cu_GetMainSubject_frm21041">
              <cm:tzDataSource.StoredProcedureParameterValue>
                <TZStoredProcedure xmlns="clr-namespace:ITS.FormGenerator.Component.SL.Controls;assembly=ITS.FormGenerator.Component.WPF" ComponentName=" (@UserID)" IsOutputParameter="False" ParameterType="int" SpParamName=" @UserId" />
              </cm:tzDataSource.StoredProcedureParameterValue>
            </cm:tzDataSource>
            <cm:tzDataSource Name="dsGetLastMonth" Content="dsGetLastMonth" Width="61.83048544" Height="25" ControlID="5332918379506863424" Canvas.Left="16.16951456" Canvas.Top="14" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:ForceReload="True" cm:RunQueryMode="StoredProcedure" cm:tzSelectQuery="Sp_Cu_GetLastMonthDate" />
            <cm:tzDataSource Name="dsUsers" Content="dsUsers" Width="136.83048544" Height="25" ControlID="5507545221695674995" Canvas.Left="418.94000000000034" Canvas.Top="6.0000000000002274" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:RunQueryMode="StoredProcedure" cm:tzSelectQuery="Sp_Cu_GetUsers_SearchQuestionAnswer" />
            <cm:tzDataGrid Name="gvQuestionAnswer" Width="1127.4300000000003" Height="403" HorizontalAlignment="Left" VerticalAlignment="Top" ControlID="5520743959566919198" ItemsSource="{Binding ElementName=dsSearchQuestionAnswer, Path=DataItems}" Canvas.Left="10.57" Canvas.Top="221.03333334" cm:BindingForm="dsSearchQuestionAnswer" cm:Event="dsSelectKey,dsSelectwfid" cm:IsSearchable="True" cm:KeyField="Id" cm:MultiSelect="True" cm:UserCanExport="True">
              <cm:tzDataGrid.Resources>
                <cm:MainCommands x:Key="MainCommands" />
                <cm:WorkFlowCommands x:Key="WorkFlowCommands" />
              </cm:tzDataGrid.Resources>
              <cm:tzDataGrid.Columns>
                ...
                <cm:tzDataGridTemplateColumn Width="40" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="RowNumber" DecimalMark="False" HeaderText="ردیف" IsRowColorField="False" KeyField="False" SortMemberPath="RowNumber">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="100" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="MainSubject" DecimalMark="False" HeaderText="موضوع اصلی" IsRowColorField="False" KeyField="False" SortMemberPath="MainSubject">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                      <TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" Text="{Binding MainSubject}" TextWrapping="Wrap" />
                    </cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="120" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="Descript" DecimalMark="False" HeaderText="درخواست" IsRowColorField="False" KeyField="False" SortMemberPath="Descript">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="RegDate" DecimalMark="False" HeaderText="تاریخ ثبت" IsRowColorField="False" KeyField="False" SortMemberPath="RegDate">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="RegTime" DecimalMark="False" HeaderText="ساعت ثبت" IsRowColorField="False" KeyField="False" SortMemberPath="RegTime">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="80" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="PersonName" DecimalMark="False" HeaderText="نام درخواست کننده" IsRowColorField="False" KeyField="False" SortMemberPath="PersonName">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                      <TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" Text="{Binding PersonName}" TextWrapping="Wrap" />
                    </cm:TzDataTemplate>
                  </cm:tzDataGridTemplateColumn.CellTemplate>
                </cm:tzDataGridTemplateColumn>
                ...
                <cm:tzDataGridTemplateColumn Width="70" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataNavigateUrl="attachment" DataTextField="attachment" DecimalMark="False" HeaderText="تصویر خطا" HyperLinkType="URL" IsRowColorField="False" KeyField="False" SortMemberPath="attachment">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                      <HyperlinkButton Content="{Binding attachment}" Command="{Binding Source={StaticResource MainCommands}, Path=ShowExtenalLink}" CommandParameter="{Binding attachment}" />
                    </cm:TzDataTemplate>
                  </cm:tzDataGridTemplateColumn.CellTemplate>
                </cm:tzDataGridTemplateColumn>
                <cm:tzDataGridTemplateColumn Width="41" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataNavigateUrl="FileID" DataTextField="FileID" DecimalMark="False" HeaderText="فایل" HyperLinkType="FileID" IsRowColorField="False" KeyField="False" SortMemberPath="FileID">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="90" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="Mobile" DecimalMark="False" HeaderText="موبایل" IsRowColorField="False" KeyField="False" SortMemberPath="Mobile">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="120" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="Email" DecimalMark="False" HeaderText="پست الکترونیکی" IsRowColorField="False" KeyField="False" SortMemberPath="Email">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="120" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="FinalDesc" DecimalMark="False" HeaderText="پاسخ" IsRowColorField="False" KeyField="False" SortMemberPath="FinalDesc">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                      <TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" Text="{Binding FinalDesc}" TextWrapping="Wrap" />
                    </cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="70" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="WorkflowInstanceStatusName" DecimalMark="False" HeaderText="وضعیت" IsRowColorField="False" KeyField="False" SortMemberPath="WorkflowInstanceStatusName">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
            ...
            <cm:tzDataSource Name="dsEnable" Content="dsEnable" Width="136.83048543999982" Height="25" ControlID="5641455391768574097" Canvas.Left="206.99999999999989" Canvas.Top="266.05658143333358" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:ForceReload="True" cm:RunQueryMode="Text" cm:tzSelectQuery="if {@txtSelectedWFID}=''''  select cast( 0 as bit) as Res else select cast( 1 as bit) as Res" />
            <cm:tzDataSource Name="dsExpert" Content="dsExpert" Width="82.505025129999979" Height="25" ControlID="5608065563350752282" Canvas.Left="180.99497487" Canvas.Top="40" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:RunQueryMode="StoredProcedure" cm:tzSelectQuery="Sp_Cu_GetExpert_SearchQuestionAnswer" />
            <cm:tzDataSource Name="dsWFStatus" Content="dsWFStatus" Width="137.93000000000052" Height="25" Canvas.Left="732" Canvas.Top="75" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:ControlID="5512409615792043579" cm:ForceReload="True" cm:RunQueryMode="StoredProcedure" cm:tzSelectQuery="Sp_Cu_GetWFStepStatus_SearchQuestionAnswer" />
            <cm:tzDataSource Name="dsSelectKey" Content="dsSelectKey" Width="115.99999999999983" Height="25" ControlID="4871665541454949817" Canvas.Left="206.99999999999989" Canvas.Top="346.08072917" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:RunQueryMode="Text" cm:tzSelectQuery="SELECT {@gvQuestionAnswer} AS Ids" />
            <cm:tzDataSource Name="dsSelectwfid" Content="dsSelectwfid" Width="137.93000000000046" Height="25" ControlID="5554416210975577959" Canvas.Left="20.569999999999538" Canvas.Top="258.10118477000003" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:RunQueryMode="Text" cm:tzSelectQuery="exec Sp_Cu_GetSelectedWFID_SearchQustionAnswer {@gvQuestionAnswer}">
              <cm:tzDataSource.StoredProcedureParameterValue>
        ...
        <cm:tzDataSource Name="dsHistory" Content="dsHistory" Width="138.93000000000046" Height="25" ControlID="5061681583334321950" Canvas.Left="43.797910389999316" Canvas.Top="690.51647727666671" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:RunQueryMode="StoredProcedure" cm:tzSelectQuery="SP_CU_SearchHistoryWF_ForSaoSupport">
          <cm:tzDataSource.StoredProcedureParameterValue>
    ...
    <cm:tzTextBox Name="txtSelectedWFID" Width="120" Height="21" ControlID="5373575373096167126" Canvas.Left="53.145372400000042" Canvas.Top="341.59876893999984" cm:DataBinding="dsSelectwfid" cm:DataBindingField="WFID" cm:Event="dsEnable,dsHistory,dsSelectReadyAnswer" cm:IsVisibleItem="False" />
    <cm:TZCheckBox Name="chbMandatory" Content="chbMandatory" Width="77" Height="20" ControlID="5535282148874238508" FontFamily="Tahoma" Canvas.Left="53.145372400000156" Canvas.Top="484.34095643" cm:DataBinding="dsMandatory" cm:DataBindingField="res" cm:IsVisibleItem="False" />
    <cm:tzDataSource Name="dsEnableBtn" Content="dsEnableBtn" Width="138.93" Height="25" Canvas.Left="49.926309900000163" Canvas.Top="374.27585227000009" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:ControlID="5621094784908548751" cm:ForceReload="True" cm:RunQueryMode="Text" cm:tzSelectQuery="if {@txtDesc}=''''  select cast( 0 as bit) as Res else select cast( 1 as bit) as Res" />
    <cm:TZCheckBox Name="chkEnableBtn" Content="chkEnableBtn" Width="74" Height="20" Canvas.Left="50.926309899999694" Canvas.Top="415.66387310000016" cm:ControlID="4804405904545522683" cm:DataBinding="dsEnableBtn" cm:DataBindingField="Res" cm:FCVCol="" cm:FECol="" cm:FMCol="" cm:FVCol="" cm:IsVisibleItem="False" cm:TCVCol="" cm:TECol="4906707026216213102#" cm:TMCol="" cm:TVCol="" />
    <cm:TZCheckBox Name="chkEnable" Content="chkEnable" Width="78" Height="20" ControlID="5494030831401772440" Canvas.Left="242.20704796000024" Canvas.Top="353.27585227000009" cm:DataBinding="dsEnable" cm:DataBindingField="Res" cm:FCVCol="" cm:FECol="" cm:FMCol="" cm:FVCol="" cm:IsVisibleItem="False" cm:TCVCol="" cm:TECol="5759606125225975486#" cm:TMCol="" cm:TVCol="" />
    <cm:tzTextBox Name="TextBox57" Width="114" Height="21" ControlID="5481516451968864003" Canvas.Left="67.700059900000042" Canvas.Top="790.09895833666712" cm:DataBinding="dsDoneTask" cm:DataBindingField="ReturnValue" cm:Event="dsSearchQuestionAnswer" cm:IsVisibleItem="False" />
    <cm:tzDataSource Name="dsDoneTask" Content="dsDoneTask" Width="137.93000000000046" Height="25" ControlID="5458078811527254674" Canvas.Left="62.022976570000253" Canvas.Top="756.09895833666712" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="" cm:RunQueryMode="Text" cm:tzSelectQuery="">
    ...
    <cm:tzTextBox Name="TextBox110" Width="255" Height="21" ControlID="5077739450199891529" Canvas.Left="234.76872352999985" Canvas.Top="430.078645836667" cm:DataBinding="dsSelectKey" cm:DataBindingField="Ids" cm:IsVisibleItem="False" />
    <cm:tzDataSource Name="dsSearchQuestionAnswer" Content="dsSearchQuestionAnswer" Width="135.93" Height="25" ControlID="5702593750632146706" Canvas.Left="437.82419517000028" Canvas.Top="315.5987689399999" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:RunQueryMode="StoredProcedure" cm:tzSelectQuery="Sp_Cu_advancedSearch_frm41608">
      <cm:tzDataSource.StoredProcedureParameterValue>
        <TZStoredProcedure xmlns="clr-namespace:ITS.FormGenerator.Component.SL.Controls;assembly=ITS.FormGenerator.Component.WPF" ComponentName=" {@cmbMainSubject}" IsOutputParameter="False" ParameterType="int" SpParamName=" @MainSubject" />
...
----------
 ...
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm41608' AND COLUMN_NAME = 'Col_5648468160086085093' )  BEGIN ALTER TABLE [dbo].[Tbl_frm41608] ADD Col_5648468160086085093 nvarchar (4000) NULL END  
 IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tbl_frm41608' AND COLUMN_NAME = 'Col_5520743959566919198' )  BEGIN ALTER TABLE [dbo].[Tbl_frm41608] ADD Col_5520743959566919198 nvarchar (4000) NULL END  
 END 
----------
