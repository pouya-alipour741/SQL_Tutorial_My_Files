 ...
 INSERT INTO Form.TblForm(FormId,Name,IsActive,Description,Resource,IsSearchForm,LastModifiedDate,GUID,ISPersistable,HelpLink,HTMLResource,DefaultCulture ) VALUES (41606, N'پاسخ های آماده درخواست پشتیبانی',1, N'', N'<cm:TZBaseControl xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:sk="http://schemas.microsoft.com/winfx/2006/xaml/presentation/sdk" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" xmlns:cm="clr-namespace:ITS.FormGenerator.Component.SL;assembly=ITS.FormGenerator.Component.WPF" xmlns:my="clr-namespace:Liquid;assembly=Liquid" xmlns:my1="clr-namespace:Liquid;assembly=RichTextEditor" Background="White">
  <Canvas Width="950" Height="570">
    ...
    <cm:Grid Width="924" Height="554" ControlID="5318419757201397511" Canvas.Left="18" Canvas.Top="8">
      ...
      <cm:tzDataSource Name="dsMainSubject" Content="dsMainSubject" Width="110" Height="25.000000000000014" Margin="16.3997023672927,92.3422812700001,0,0" HorizontalAlignment="Left" VerticalAlignment="Top" ControlID="5207340050635669024" Grid.Column="1" Grid.Row="0" cm:AWorkFlowInstanceId="-1" cm:ConnectionName="SAODB" cm:RunQueryMode="StoredProcedure" cm:tzSelectQuery="Sp_Cu_GetMainSubject_frm41606">
...
</cm:TZBaseControl>',IsSearchForm = 1,LastModifiedDate = '1403/11/14 11:16:42', GUID = 'c5ec7a30-126c-4e69-8819-8053032a018c', ISPersistable = 0,HelpLink = N'',HTMLResource = N'{"formID": "41606" ,"components": [{"value": "","key": "4756151329983957276","label": "chkFilledMainSubject","controlType": "checkbox","caption": "TZCheckBox" ,"DataBindingField" : "res"},{"key": "4936476346195877437","label": "cmbMainSubject","value": "", "controlType": "dropdown","options":""},{"key":"4733857338082025567" , "dataSourceName":"dschkFilledMainSubject" , "controlType": "datasource",  "selectQuery" :"sp_cu_chk_IsMainSubjectEmpty" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"key":"5325081676817357846" , "dataSourceName":"dsgvPremadeResponses" , "controlType": "datasource",  "selectQuery" :"sp_cu_gvPremadeResponses_frm41606" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"key":"5207340050635669024" , "dataSourceName":"dsMainSubject" , "controlType": "datasource",  "selectQuery" :"Sp_Cu_GetMainSubject_frm41606" , "connectionName" :"SAODB" , "runQueryMode":"StoredProcedure" , "relatedComponent" :[] } ,{"value": "$CurrentUserId","key": "4933789186363820479","label": "txtUserID","controlType": "textbox", "type": "" , "DataBindingField" : ""}],"layouts":[]}',DefaultCulture = NULL  WHERE FormId = 41606
GO
----------
          ...
          <Canvas>
            ...
            <cm:tzDataGrid Name="gvQuestionAnswer" Width="1127.4300000000003" Height="403" HorizontalAlignment="Left" VerticalAlignment="Top" ControlID="5520743959566919198" ItemsSource="{Binding ElementName=dsSearchQuestionAnswer, Path=DataItems}" Canvas.Left="10.57" Canvas.Top="221.03333334" cm:BindingForm="dsSearchQuestionAnswer" cm:Event="dsSelectKey,dsSelectwfid" cm:IsSearchable="True" cm:KeyField="Id" cm:MultiSelect="True" cm:UserCanExport="True">
              ...
              <cm:tzDataGrid.Columns>
                ...
                <cm:tzDataGridTemplateColumn Width="75" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="MainSubject" DecimalMark="False" HeaderText="موضوع اصلی" IsRowColorField="False" KeyField="False" SortMemberPath="MainSubject">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                      <TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" Text="{Binding MainSubject}" TextWrapping="Wrap" />
                    </cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="59" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="Descript" DecimalMark="False" HeaderText="درخواست" IsRowColorField="False" KeyField="False" SortMemberPath="Descript">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="91" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="RegisteredDate" DecimalMark="False" HeaderText="تاریخ ثبت" IsRowColorField="False" KeyField="False" SortMemberPath="RegisteredDate">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="92" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="RegisteredTime" DecimalMark="False" HeaderText="زمان ثبت" IsRowColorField="False" KeyField="False" SortMemberPath="RegisteredTime">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="77" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="PersonName" DecimalMark="False" HeaderText="نام درخواست کننده" IsRowColorField="False" KeyField="False" SortMemberPath="PersonName">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="44" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="Mobile" DecimalMark="False" HeaderText="موبایل" IsRowColorField="False" KeyField="False" SortMemberPath="Mobile">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="39" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="Email" DecimalMark="False" HeaderText="پست الکترونیکی" IsRowColorField="False" KeyField="False" SortMemberPath="Email">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="60" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="FinalDesc" DecimalMark="False" HeaderText="پاسخ" IsRowColorField="False" KeyField="False" SortMemberPath="FinalDesc">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                      <TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" Text="{Binding FinalDesc}" TextWrapping="Wrap" />
                    </cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="85" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="LogStatusTitle" DecimalMark="False" HeaderText="مرحله فرآیند" IsRowColorField="False" KeyField="False" SortMemberPath="LogStatusTitle">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
                ...
                <cm:tzDataGridTemplateColumn Width="169" HorizontalAlignment="Left" VerticalAlignment="Top" CandidateControlId="" CandidateKey="False" CanUserSort="True" DataTextField="WorkflowInstanceStatusName" DecimalMark="False" HeaderText="وضعیت" IsRowColorField="False" KeyField="False" SortMemberPath="WorkflowInstanceStatusName">
                  <cm:tzDataGridTemplateColumn.CellTemplate>
                    <cm:TzDataTemplate>
